...
#define i386SetNormalPte(pte, page_number, user_page) \
    i386SetPte(pte, page_number, user_page, TRUE, TRUE, FALSE, FALSE, FALSE);

#define i386SetLargePte(pte, page_number, user_page) \
    i386SetPte(pte, page_number, user_page, TRUE, TRUE, FALSE, TRUE, FALSE);
